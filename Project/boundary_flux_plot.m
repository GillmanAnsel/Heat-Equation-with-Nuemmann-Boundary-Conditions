...
text(Tf-0.15, flux_left(end)+0.1, sprintf('Left final: %.2e', flux_left(end)), ...
    'FontSize', 10, 'Color', 'blue', 'FontWeight', 'bold', 'BackgroundColor', 'white');

% Right boundary (red)
text(0.05, flux_right(1)*1.15, sprintf('Right init: %.3f', flux_right(1)), ...
    'FontSize', 10, 'Color', 'red', 'FontWeight', 'bold', 'BackgroundColor', 'white');
text(Tf-0.15, flux_right(end)-0.1, sprintf('Right final: %.2e', flux_right(end)), ...
    'FontSize', 10, 'Color', 'red', 'FontWeight', 'bold', 'BackgroundColor', 'white');
