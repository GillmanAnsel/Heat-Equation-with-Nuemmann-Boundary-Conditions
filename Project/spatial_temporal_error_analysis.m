...
hold on;
semilogy(T_fine, pi/2 * exp(-T_fine), 'r--', 'LineWidth', 2, 'DisplayName', '$\frac{\pi}{2}e^{-t}$ (theoretical)');
xlabel('Time t', 'FontSize', 11);
ylabel('$\|u(\cdot,t)\|_{L^2}$', 'FontSize', 11, 'Interpreter', 'latex');
title('L² Norm Decay (Solution Magnitude)', 'FontSize', 12, 'Interpreter', 'latex');
grid on;
...
hold on;
semilogy(T_fine, exp(-T_fine), 'r--', 'LineWidth', 2, 'DisplayName', '$e^{-t}$ (theoretical)');
xlabel('Time t', 'FontSize', 11);
ylabel('$\max_x |u(x,t)|$', 'FontSize', 11, 'Interpreter','latex');
title('Max Norm Decay', 'FontSize', 12, 'Interpreter', 'latex');
grid on;
legend('FEM Solution', 'Theoretical decay', 'FontSize', 10, 'Interpreter', 'latex');
hold off;
...
title('Solution $u(x,t)$ Heatmap', 'FontSize', 12, 'Interpreter', 'latex');
colormap(gca, 'hot');
...
sgtitle('Solution Dynamics and Error Evolution', 'FontSize', 14, 'Interpreter', 'latex');
